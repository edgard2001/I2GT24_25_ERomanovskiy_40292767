...
namespace Player.Camera
{
    ...
    {
        [Header("Chase")] [SerializeField] private Vector3 offset = Vector3.up;
        [SerializeField] private float cameraChaseSpeed = 4f;

        [Header("Collision")] [SerializeField] private float minDistance = 0.1f;
        [SerializeField] private float maxDistance = 10;
        [SerializeField] private float sphereCheckRadius = 0.1f;
        [SerializeField] private LayerMask layerMask;

        [Header("Input")] [SerializeField] private float lookSensitivityMultiplier = 200;
        ...
        {
            _pivotTransform.rotation = Quaternion.Euler(_pitch, _yaw, 0) * _startRotation;
            Vector3 targetPosition = _playerTransform.position + offset.x * _pivotTransform.right +
            ...
            {
                _pitch = Mathf.Clamp(_pitch, 10, 60);
                _pivotTransform.rotation = Quaternion.Euler(_pitch, _yaw, 0) * _startRotation;
            }
